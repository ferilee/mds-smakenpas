  ...
  const sidebarGroups = [
    {
      ...
      items: [
        ...
        { label: "Filter Laporan", href: "/admin/dashboard#filter-laporan" },
        { label: "Heatmap Kelas", href: "/admin/dashboard#heatmap-kelas" },
      ],
    },
    {
      title: "Manajemen",
      items: [
        ...
        { label: "Daftar Siswa", href: "/admin/dashboard#daftar-siswa" },
      ],
    },
    {
      title: "Analitik",
      items: [
        { label: "Analitik Kelas", href: "/admin/dashboard#analitik-kelas" },
        { label: "Laporan Terbaru", href: "/admin/dashboard#laporan-terbaru" },
